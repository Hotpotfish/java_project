...
public class WriteRecords {
  public static void main(String[] args) {
    ...
    try {
    	...
    	obout.writeObject(rec1);
    	obout.writeObject(rec2);
    	obout.writeObject(rec3);
    	obout.writeObject(rec4);
    	obout.writeObject(rec5);
    	obout.flush(); 
    	obout.close();
      /***
      **** Step 1: declare and initialize the record output stream(done)
      ***/
      /***
