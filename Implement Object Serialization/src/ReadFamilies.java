...
public class ReadFamilies {
  public static void main(String[] args) {
    ...
    try {
    	ObjectInputStream obinput = new ObjectInputStream(new FileInputStream("families.ser"));
    	family1 = (Family)obinput.readObject();
    	family2 = (Family)obinput.readObject();
    	family3 = (Family)obinput.readObject();
    	obinput.close();
